 ...
 * por MQTT para controlar el LedFlash.
 * 
...
//Datos de WiFi
const char* ssid = "MaGualu";  // Aquí debes poner el nombre de tu red
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "codigoIoT/flow6/mqttin") {  // En caso de recibirse mensaje en el tema esp32/output
    if(messageTemp == "true"){
